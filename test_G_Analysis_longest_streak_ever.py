...
the G_Analysis_longest_streak_ever module using the same sample data. The longest streak ever has been calculated
...
def test_calculate_and_print_longest_streaks_ever(capsys):
    ...
    G_Analysis_longest_streak_ever.calculate_and_print_longest_streaks_ever('test_Habit_app_database.db',
                                                                            'Habit_table',
                                                                            'Progression_table')
