...
def test_update_function(capsys):
    ...
    from the H_Update_progression module and providing a test db with mocked input for 'today' and 'yesterday'. Next,
    ...
    J_Insert_sample_data.insert_sample_data_before_distribution_of_app('test_Habit_app_database.db',
                                                                       'Habit_table',
                                                                       'Date_table',
                                                                       'Progression_table')
    ...
    with mock.patch('builtins.input', side_effect=['3', 'meditate', '1', '1', '3', 'meditate', '1', 'm']):
        H_Update_progression.update_function('test_Habit_app_database.db')
