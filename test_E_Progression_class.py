...
def test_combine_habits_dates():
    ...
    J_Insert_sample_data.insert_sample_habit_data_and_dates('test_Habit_app_database.db', 'Habit_table',
                                                            'Date_table', 'Progression_table')
    J_Insert_sample_data.insert_sample_progression_data('test_Habit_app_database.db', 'Habit_table',
                                                        'Date_table', 'Progression_table')
    ...
    J_Insert_sample_data.insert_sample_habit_data_and_dates('test_Habit_app_database2.db', 'Habit_table',
                                                            'Date_table', 'Progression_table')
    #
    ...
    E_Progression_class.Progression.combine_habits_dates('test_Habit_app_database2.db',
                                                         'Habit_table',
                                                         'Date_table',
                                                         'Progression_table')
