...
the F_Analysis_current_streak_per_habit module using the same sample data. The streaks have been calculated
...
def test_calculate_daily_and_weekly_streaks(capsys):
    ...
    J_Insert_sample_data.insert_sample_habit_data_and_dates('test_Habit_app_database.db',
                                                            'Habit_table',
                                                            'Date_table',
                                                            'Progression_table')
    J_Insert_sample_data.insert_sample_progression_data('test_Habit_app_database.db',
                                                        'Habit_table',
                                                        'Date_table',
                                                        'Progression_table')
    ...
    F_Analysis_current_streak_per_habit.calculate_and_print_streaks('test_Habit_app_database.db',
                                                                    'Habit_table',
                                                                    'Progression_table')
...
def test_calculate_daily_and_weekly_streaks_after_table_update(capsys):
    ...
    E_Progression_class.Progression.combine_habits_dates('test_Habit_app_database.db',
                                                         'Habit_table',
                                                         'Date_table',
                                                         'Progression_table')
