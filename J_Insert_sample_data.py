...
def insert_sample_habit_data_and_dates(database, habit_table_name, date_table_name, progression_table_name):
    ...
    B_Table_module.check_and_create_database(database)
    B_Table_module.create_habit_table(habit_table_name, database)
    B_Table_module.create_date_table(date_table_name, database)
    B_Table_module.create_progression_table(progression_table_name, database)

    D_Date_class.Date.update_dates(database, date_table_name)
...
def insert_sample_progression_data(database, habit_table_name, date_table_name, progression_table_name):
    ...
    pandas.read_csv('X_Sample_data.csv', sep=';').to_sql(progression_table_name, dbconnection,
